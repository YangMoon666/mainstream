window.onload = function () {
    ...
    function documentActions(e) {
        ...
        if (targetElement.closest('.section__1__active')) {
            ...
            document.querySelector('#a1 h3').classList.toggle('active');
            ...
            document.querySelector('#a2 h3').classList.toggle('active');
            ...
            document.querySelector('#a3 h3').classList.toggle('active');
            ...
            document.querySelector('#a4 h3').classList.toggle('active');
            ...
            document.querySelector('#a5 h3').classList.toggle('active');
